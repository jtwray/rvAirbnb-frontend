...
import LoginForm from "../src/auth_views/login/LoginForm";
import { renderWithReduxAndRouter } from "../src/utils/testing/renderWithReduxAndRouter.js";
...
test("allows the user to login successfully", async () => {
  ...
  expect(window.localStorage.getItem("currentUser")).toEqual(
    fakeUserResponse.currentUser
  );
  expect(window.localStorage.getItem("is_authenticated")).toEqual(
    fakeUserResponse.currentUser
  );
});
